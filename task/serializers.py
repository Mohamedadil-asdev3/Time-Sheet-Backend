...
class TaskListSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        # ─── Automatic L1 approver = creator's direct supervisor ───
        if hasattr(creator, 'user_id_supervisor') and creator.user_id_supervisor:
            validated_data['l1_approver'] = creator.user_id_supervisor

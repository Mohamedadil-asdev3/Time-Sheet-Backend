...
TimeDistributionAPIView,RecentTasksAPIView,TopUsedTasksAPIView,TopPlatformsAPIView,PlatformPerformanceAPIView,ProfileAPIView,ApprovalTableAPIView,
 RecentRequestAPIView,ApprovalStatusOverviewAPIView,BulkTaskListUpdate, TaskApproverAPIView
...
urlpatterns = [
    ...
    path('tasks/<int:pk>/action/', TaskApproverAPIView.as_view(),name='approve-reject'),
